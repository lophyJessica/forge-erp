...
const manualSections: ManualSection[] = [
  ...
  },
  {
    ...
    diagramNote: 'PRD 套件没有提供独立 Mermaid flowchart，本手册不凭空重画流程图。',
    steps: [
    ...
    <section id={section.id} className="scroll-mt-6 space-y-5 rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <div className="space-y-3">
        ...
        {section.diagram ? (
          ...
          <div className="rounded-md border border-amber-200 bg-amber-50 p-4 text-xs font-semibold text-amber-800">
            {section.diagramNote}
          </div>
        )}
      </div>
